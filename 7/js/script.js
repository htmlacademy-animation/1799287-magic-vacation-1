...
class AccentTypographyBuild {
 constructor(
  ...
  createElement(letter, index, wordNumber) {
    const span = document.createElement(`span`);
    span.textContent = letter;
    span.style.transition = `${this._property} ${this._timer}ms ease ${this._timeOffset[wordNumber][index]}ms`;
    return span;
  }
  ...
  prePareText() {
    ...
    const content = text.reduce((fragmentParent, word, index) => {
      ...
      const wordElement = Array.from(word).reduce((fragment, latter,index) => {
        fragment.appendChild(this.createElement(latter,index, wordNumber));
        return fragment;
...
/* harmony default export */ __webpack_exports__["default"] = (() => { 
  ...
  const animationTopScreenTextLine = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`, 1700, `active`, `transform`, [[90, 70, 0, 70, 85, 70, 0, 150, 70, 0, 70, 0], [263, 224, 254, 196, 290, 253.5]]);
const animationTopScreenTextLineHistory = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.slider__item-title`, 1700, `active`, `transform`, [[127, 84, 0, 70, 96, 72, 0]]);
const animationTopScreenTextLinePrize = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.prizes__title`, 1700, `active`, `transform`, [[127, 84, 10, 70, 96]]);
const animationTopScreenTextLineRules = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.rules__title`, 1700, `active`, `transform`, [[127, 84, 10, 70, 96, 96, 70]]);
const animationTopScreenTextLineGame = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.game__title`, 1700, `active`, `transform`, [[127, 84, 10, 10]]);
      ...
      storySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-slider`, {
        ...
        on: {
          slideChange: () => {
            ...
            } else if (storySlider.activeIndex === 3){
...
/* harmony import */ var _modules_load__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/load */ "./source/js/modules/load.js");
// modules
...
Object(_modules_load__WEBPACK_IMPORTED_MODULE_9__["default"])();
